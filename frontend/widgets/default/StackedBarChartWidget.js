...
// each become their own bar series, stacked into a single bar per category
// (same row->series convention as bar_chart, but with `stack` set so the
// series pile up instead of rendering side-by-side).
