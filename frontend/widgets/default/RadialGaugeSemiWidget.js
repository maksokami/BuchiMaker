            ...
            try {
                chart.setOption({
                    series: [{
                        ...
                        splitNumber: 1, radius: '100%', center: ['50%', '70%'],
                        pointer: { show: false },
                        ...
                        data: [{
                            value: val,
                            detail: { valueAnimation: true, offsetCenter: ['0%', '-10%'], formatter: '{value}%', fontSize: 28, fontWeight: 400 }
                        }]
                    }]
                });
